    ...
    <section className="filter">
      ...
      >
        ...
        <button
          ...
          className="text-gray-400 bg-transparent hover:bg-gray-200 cursor-pointer hover:text-gray-900 rounded-lg text-sm p-1.5 absolute top-2.5 right-2.5 inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
        >
          <IoClose size={24} />
            ...
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                <input
                  ...
                  value=""
                  name="price-sort"
                  className="w-4 h-4 text-rose-600 cursor-pointer bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                />
                <label
            ...
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                <input
                  ...
                  type="checkbox"
                  value=""
                  className="w-4 h-4 text-rose-600 cursor-pointer bg-gray-100 rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                />
                <label
                  htmlFor="best-seller"
                  className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"
