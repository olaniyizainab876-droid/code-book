      ...
      <main className="mx-auto max-w-7xl px-4 py-12">
        <div className="text-center">
          ...
          <button
            ...
            className="mt-4 cursor-pointer  hover:bg-rose-700 text-white font-medium py-2 px-4 rounded-lg"
          >
            Back to Products
          </button>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <button
            ...
            className={`w-full bg-rose-600 hover:bg-rose-700 cursor-pointer text-white font-medium py-2 rounded-lg transition ${!product.in_stock ? "cursor-not-allowed opacity-50" : ""}`}
          >
