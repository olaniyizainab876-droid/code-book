...
const getAnEbook=asyncHandler(async(req,res)=>{
     ...
     if(ebook){
          const {_id,id,name,overview,longDescription,price,instock,poster,rating,bestSeller,seize,}=ebook;

          res
            .status(200)
            .json({_id,id,name,overview,longDescription, price,instock,poster,rating,bestSeller,seize,});
     }else{
